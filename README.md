...
- [Download the latest release](https://github.com/coreui/coreui/archive/v5.7.1.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui:5.7.1`
