...
- [Download the latest release](https://github.com/coreui/coreui/archive/v5.6.0.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui:5.6.0`
