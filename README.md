...
- [Download the latest release](https://github.com/coreui/coreui/archive/v4.0.0-rc.1.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui:4.0.0-rc.1`
