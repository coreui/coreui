...
<Example lang="html" html={[`<div class="docs-callout my-0">`, `    <strong>This is a callout.</strong> We built it custom for our docs so our messages to you stand out. It has three variants via modifier classes.`, `  </div>`]} />
