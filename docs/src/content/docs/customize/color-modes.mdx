...
<Example lang="html" name="customize-color-modes-1" componentName="Color modes" class="d-flex justify-content-between" code={`<div class="dropdown" data-coreui-theme="light">
