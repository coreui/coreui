...
<Example lang="html" name="forms-validation-1" componentName="Validation" code={`<form class="row g-3 needs-validation" novalidate>
    <div class="col-md-4">
...
<Example lang="html" name="forms-validation-3" componentName="Validation" code={`<form class="row g-3">
    <div class="col-md-4">
...
<Example lang="html" name="forms-validation-4" componentName="Validation" code={`<form class="row g-3">
    <div class="col-md-4">
...
<Example lang="html" name="forms-validation-5" componentName="Validation" code={`<form class="was-validated">
    <div class="mb-3">
...
<Example lang="html" name="forms-validation-6" componentName="Validation" code={`<form class="row g-3 needs-validation" novalidate>
...
<ScssDocs file="scss/_variables.scss" capture="form-feedback-variables" />
...
<ScssDocs file="scss/_variables.scss" capture="form-validation-states" />
