...
<Example lang="html" name="helpers-focus-ring-1" componentName="Focus ring" code={`<a href="#" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">
    Custom focus ring
  </a>`} />
...
<Example lang="html" name="helpers-focus-ring-2" componentName="Focus ring" code={`<a href="#" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--cui-focus-ring-color: rgba(var(--cui-success-rgb), .25)">
    Green focus ring
  </a>`} />
...
<Example lang="html" name="helpers-focus-ring-3" componentName="Focus ring" code={`<a href="#" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--cui-focus-ring-x: 10px; --cui-focus-ring-y: 10px; --cui-focus-ring-blur: 4px">
...
<Example lang="html" name="helpers-focus-ring-4" componentName="Focus ring" code={`<p><a href="#" class="d-inline-flex focus-ring focus-ring-primary py-1 px-2 text-decoration-none border rounded-2">Primary focus</a></p>
