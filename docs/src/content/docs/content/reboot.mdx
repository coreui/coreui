...
<Example lang="html" name="content-reboot-1" componentName="Reboot" code={`<hr>
...
<Example lang="html" name="content-reboot-2" componentName="Reboot" code={`For example, <code>&lt;section&gt;</code> should be wrapped as inline.`} />

## Code blocks

Use `<pre>`s for multiple lines of code. Once again, be sure to escape any angle brackets in the code for proper rendering. The `<pre>` element is reset to remove its `margin-top` and use `rem` units for its `margin-bottom`.

<Example lang="html" name="content-reboot-3" componentName="Reboot" code={`<pre><code>&lt;p&gt;Sample text here...&lt;/p&gt;
...
<Example lang="html" name="content-reboot-4" componentName="Reboot" code={`<var>y</var> = <var>m</var><var>x</var> + <var>b</var>`} />

## User input

Use the `<kbd>` to indicate input that is typically entered via keyboard.

<Example lang="html" name="content-reboot-5" componentName="Reboot" code={`To switch directories, type <kbd>cd</kbd> followed by the name of the directory.<br>
...
<Example lang="html" name="content-reboot-6" componentName="Reboot" code={`<samp>This text is meant to be treated as sample output from a computer program.</samp>`} />
...
<Example lang="html" name="content-reboot-7" componentName="Reboot" code={`<table>
    <caption>
...
<Example lang="html" name="content-reboot-8" componentName="Reboot" code={`<span role="button" tabindex="0">Non-button element button</span>`} />
