...
<Example lang="html" name="icons-1" componentName="CoreUI Icons" code={[`<i class="cil-paperclip icon icon-xxl"></i>`, `<i class="cil-tag icon icon-xxl"></i>`]} html={[`<i class="cil-paperclip icon icon-xxl"></i>`, `<i class="cil-tag icon icon-xxl"></i>`]} />
