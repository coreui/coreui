...
<Example lang="html" name="components-header-1" componentName="Header" code={`<header class="header">
...
<Example lang="html" name="components-header-2" componentName="Header" code={`<!-- As a link -->
  <header class="header">
...
<Example lang="html" name="components-header-3" componentName="Header" code={`<!-- Just an image -->
  <header class="header">
    <a class="header-brand" href="#">
...
<Example lang="html" name="components-header-4" componentName="Header" code={`<!-- Image and text -->
  <header class="header">
    <a class="header-brand" href="#">
      <img src="/assets/brand/coreui-signet.svg" alt="" width="22" height="24" class="d-inline-block align-top" alt="CoreUI Logo">
      CoreUI
...
<Example lang="html" name="components-header-5" componentName="Header" code={`<header class="header">
    <a class="header-brand" href="#">CoreUI</a>
    <ul class="header-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Home <span class="visually-hidden">(current)</span></a>
...
<Example lang="html" name="components-header-6" componentName="Header" code={`<header class="header">
    <a class="header-brand" href="#">CoreUI</a>
...
<Example lang="html" name="components-header-7" componentName="Header" code={`<header class="header">
    <a class="header-brand" href="#">CoreUI</a>
    <ul class="header-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Home <span class="visually-hidden">(current)</span></a>
...
<Example lang="html" name="components-header-8" componentName="Header" code={`<header class="header">
    <form class="d-flex">
      <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
      <button class="btn btn-outline-success" type="submit">Search</button>
    </form>
...
<Example lang="html" name="components-header-9" componentName="Header" code={`<header class="header">
...
<Example lang="html" name="components-header-10" componentName="Header" code={`<header class="header">
    <form class="d-flex">
...
<Example lang="html" name="components-header-11" componentName="Header" code={`<header class="header">
    <form class="d-flex">
...
<Example lang="html" name="components-header-12" componentName="Header" code={`<header class="header">
...
<Example lang="html" name="components-header-13" componentName="Header" code={`<div class="container">
    <header class="header">
      <a class="header-brand" href="#">CoreUI</a>
    </header>
  </div>`} />
...
<Example lang="html" name="components-header-14" componentName="Header" code={`<header class="header">
    <div class="container">
      <a class="header-brand" href="#">CoreUI</a>
    </div>
  </header>`} />
