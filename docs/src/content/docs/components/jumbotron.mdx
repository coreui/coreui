...
<Example lang="html" name="components-jumbotron-1" componentName="Jumbotron" code={`<div class="p-5 mb-4 bg-body-tertiary rounded-3">
...
<Example lang="html" name="components-jumbotron-2" componentName="Jumbotron" code={`<div class="p-5 text-center bg-body-tertiary">
...
<Example lang="html" name="components-jumbotron-3" componentName="Jumbotron" code={`<div class="row align-items-md-stretch">
    <div class="col-md-6">
