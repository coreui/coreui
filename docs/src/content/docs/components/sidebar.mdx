...
<Example lang="html" name="components-sidebar-1" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end h-100">
...
<Example lang="html" name="components-sidebar-2" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar sidebar-narrow border-end">
...
<Example lang="html" name="components-sidebar-3" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar sidebar-narrow-unfoldable border-end">
    <div class="sidebar-header">
      <div class="sidebar-brand">
        <svg role="img" aria-label="CoreUI Logo Full" class="d-sidebar-narrow-none" width="88" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 312 115">
          <g style="fill: currentColor">
...
<Example lang="html" name="components-sidebar-4" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end">
...
<Example lang="html" name="components-sidebar-5" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end">
    <ul class="sidebar-nav sidebar-nav-tree" data-coreui-navigation>
      <li class="nav-item nav-group show">
        <a class="nav-link nav-group-toggle" href="#">
...
<Example lang="html" name="components-sidebar-6" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end">
...
<Example lang="html" name="components-sidebar-7" componentName="Sidebar" class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end">
    <ul class="sidebar-nav" data-coreui-navigation>
      <li class="nav-item nav-group show">
        <a class="nav-link nav-group-toggle" href="#">
          <i class="nav-icon cil-puzzle"></i> Items group
...
<Example lang="html" name="components-sidebar-8" componentName="Sidebar" class="p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar sidebar-dark border-end">
    <div class="sidebar-header">
      <div class="sidebar-brand">
...
<ScssDocs file="scss/_variables.scss" capture="sidebar-variables" />
