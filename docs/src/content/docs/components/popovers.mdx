...
<Example lang="html" name="components-popovers-2" componentName="Popovers" code={`<button type="button" class="btn btn-secondary" data-coreui-container="body" data-coreui-toggle="popover" data-coreui-placement="top" data-coreui-content="Top popover">
    Popover on top
  </button>
  ...
  <button type="button" class="btn btn-secondary" data-coreui-container="body" data-coreui-toggle="popover" data-coreui-placement="left" data-coreui-content="Left popover">
    Popover on left
  </button>`} sandboxJs={[`document`, `  .querySelectorAll('[data-coreui-toggle="popover"]')`, `  .forEach(popover => {`, `    new coreui.Popover(popover)`, `  })`].join('\n')} />
...
<Example lang="html" name="components-popovers-3" componentName="Popovers" code={`<button type="button" class="btn btn-secondary"
...
<Example lang="html" name="components-popovers-5" componentName="Popovers" code={`<span class="d-inline-block" tabindex="0" data-coreui-toggle="popover" data-coreui-trigger="hover focus" data-coreui-content="Disabled popover">
