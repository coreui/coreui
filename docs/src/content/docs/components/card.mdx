...
<Example lang="html" name="components-card-1" componentName="Card" code={`<div class="card" style="width: 18rem;">
...
<Example lang="html" name="components-card-2" componentName="Card" code={`<div class="card">
    <div class="card-body">
...
<Example lang="html" name="components-card-3" componentName="Card" code={`<div class="card" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
...
<Example lang="html" name="components-card-4" componentName="Card" code={`<div class="card" style="width: 18rem;">
    <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
    <div class="card-body">
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    </div>
...
<Example lang="html" name="components-card-5" componentName="Card" code={`<div class="card" style="width: 18rem;">
...
<Example lang="html" name="components-card-6" componentName="Card" code={`<div class="card" style="width: 18rem;">
...
<Example lang="html" name="components-card-7" componentName="Card" code={`<div class="card" style="width: 18rem;">
    <ul class="list-group list-group-flush">
      <li class="list-group-item">An item</li>
      <li class="list-group-item">A second item</li>
      <li class="list-group-item">A third item</li>
...
<Example lang="html" name="components-card-8" componentName="Card" code={`<div class="card" style="width: 18rem;">
    <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
<Example lang="html" name="components-card-9" componentName="Card" code={`<div class="card">
    <div class="card-header">
      Featured
    </div>
    <div class="card-body">
...
<Example lang="html" name="components-card-10" componentName="Card" code={`<div class="card">
...
<Example lang="html" name="components-card-11" componentName="Card" code={`<div class="card">
    <div class="card-header">
      Quote
    </div>
    <div class="card-body">
...
<Example lang="html" name="components-card-12" componentName="Card" code={`<div class="card text-center">
    <div class="card-header">
      Featured
    </div>
    <div class="card-body">
...
<Example lang="html" name="components-card-13" componentName="Card" code={`<div class="row">
...
<Example lang="html" name="components-card-14" componentName="Card" code={`<div class="card w-75 mb-3">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
...
<Example lang="html" name="components-card-15" componentName="Card" code={`<div class="card" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title">Special title treatment</h5>
      <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
      <a href="#" class="btn btn-primary">Go somewhere</a>
...
<Example lang="html" name="components-card-16" componentName="Card" code={`<div class="card mb-3" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title">Special title treatment</h5>
      <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
      <a href="#" class="btn btn-primary">Go somewhere</a>
...
<Example lang="html" name="components-card-17" componentName="Card" code={`<div class="card text-center">
    <div class="card-header">
...
<Example lang="html" name="components-card-18" componentName="Card" code={`<div class="card text-center">
    <div class="card-header">
...
<Example lang="html" name="components-card-19" componentName="Card" code={`<div class="card mb-3">
    <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
...
<Example lang="html" name="components-card-20" componentName="Card" code={`<div class="card text-bg-dark">
...
<Example lang="html" name="components-card-21" componentName="Card" code={`<div class="card mb-3" style="max-width: 540px;">
    <div class="row g-0">
      <div class="col-md-4">
...
<Example lang="html" name="components-card-22" componentName="Card" code={`<div class="card text-bg-primary mb-3" style="max-width: 18rem;">
...
<Example lang="html" name="components-card-23" componentName="Card" code={`<div class="card border-primary mb-3" style="max-width: 18rem;">
    <div class="card-header">Header</div>
...
<Example lang="html" name="components-card-24" componentName="Card" code={`<div class="card border-top-primary border-top-3 mb-3" style="max-width: 18rem;">
    <div class="card-header">Header</div>
    <div class="card-body text-primary">
      <h5 class="card-title">Primary card title</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
<Example lang="html" name="components-card-25" componentName="Card" code={`<div class="card border-success mb-3" style="max-width: 18rem;">
...
<Example lang="html" name="components-card-26" componentName="Card" code={`<div class="card-group">
    <div class="card">
      <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
...
<Example lang="html" name="components-card-27" componentName="Card" code={`<div class="card-group">
    <div class="card">
      <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
...
<Example lang="html" name="components-card-28" componentName="Card" code={`<div class="row row-cols-1 row-cols-md-2 g-4">
    <div class="col">
      <div class="card">
...
<Example lang="html" name="components-card-29" componentName="Card" code={`<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card">
        <svg class="docs-placeholder-img card-img-top" width="100%" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
        <div class="card-body">
...
<Example lang="html" name="components-card-30" componentName="Card" code={`<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
...
<Example lang="html" name="components-card-31" componentName="Card" code={`<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card h-100">
        <svg class="docs-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Image cap</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
        <div class="card-body">
...
<ScssDocs file="scss/_variables.scss" capture="card-variables" />
