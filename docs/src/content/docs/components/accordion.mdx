...
<Example lang="html" name="components-accordion-1" componentName="Accordion" code={`<div class="accordion" id="accordionExample">
...
<Example lang="html" name="components-accordion-2" componentName="Accordion" class="bg-body-secondary" code={`<div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item">
      <h2 class="accordion-header">
...
<Example lang="html" name="components-accordion-3" componentName="Accordion" code={`<div class="accordion" id="accordionPanelsStayOpenExample">
    <div class="accordion-item">
      <h2 class="accordion-header">
...
<ScssDocs file="scss/_variables.scss" capture="accordion-variables" />
