...
<Example lang="html" name="components-badge-1" componentName="Badges" code={`<h1>Example heading <span class="badge text-bg-secondary">New</span></h1>
...
<Example lang="html" name="components-badge-2" componentName="Badges" code={`<button type="button" class="btn btn-primary">
...
<Example lang="html" name="components-badge-3" componentName="Badges" code={`<button type="button" class="btn btn-primary position-relative">
    Inbox
...
<Example lang="html" name="components-badge-4" componentName="Badges" code={`<button type="button" class="btn btn-primary position-relative">
    Profile
...
<Example lang="html" name="components-badge-5" componentName="Badges" code={`<span class="badge text-bg-primary">Primary</span>
...
<Example lang="html" name="components-badge-6" componentName="Badges" code={`<span class="badge rounded-pill text-bg-primary">Primary</span>
