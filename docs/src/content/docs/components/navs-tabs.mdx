...
<Example lang="html" name="components-navs-tabs-1" componentName="Navs and tabs" code={`<ul class="nav">
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-2" componentName="Navs and tabs" code={`<nav class="nav">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example lang="html" name="components-navs-tabs-3" componentName="Navs and tabs" code={`<ul class="nav justify-content-center">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-4" componentName="Navs and tabs" code={`<ul class="nav justify-content-end">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-5" componentName="Navs and tabs" code={`<ul class="nav flex-column">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-6" componentName="Navs and tabs" code={`<nav class="nav flex-column">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example lang="html" name="components-navs-tabs-7" componentName="Navs and tabs" code={`<ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-8" componentName="Navs and tabs" code={`<ul class="nav nav-pills">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-9" componentName="Navs and tabs" code={`<ul class="nav nav-underline">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-10" componentName="Navs and tabs" code={`<ul class="nav nav-underline-border">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-11" componentName="Navs and tabs" code={`<ul class="nav nav-enclosed">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-12" componentName="Navs and tabs" code={`<ul class="nav nav-enclosed nav-enclosed-pills">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-13" componentName="Navs and tabs" code={`<ul class="nav nav-pills nav-fill">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-14" componentName="Navs and tabs" code={`<nav class="nav nav-pills nav-fill">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example lang="html" name="components-navs-tabs-15" componentName="Navs and tabs" code={`<ul class="nav nav-pills nav-justified">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example lang="html" name="components-navs-tabs-16" componentName="Navs and tabs" code={`<nav class="nav nav-pills nav-justified">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example lang="html" name="components-navs-tabs-17" componentName="Navs and tabs" code={`<nav class="nav nav-pills flex-column flex-sm-row">
...
<Example lang="html" name="components-navs-tabs-18" componentName="Navs and tabs" code={`<ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
...
<Example lang="html" name="components-navs-tabs-19" componentName="Navs and tabs" code={`<ul class="nav nav-pills">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item dropdown">
