...
<Example lang="html" name="components-avatar-1" componentName="Avatar" code={`<div class="avatar">
...
<Example lang="html" name="components-avatar-2" componentName="Avatar" code={`<div class="avatar bg-primary text-white">CUI</div>
...
<Example lang="html" name="components-avatar-3" componentName="Avatar" code={`<div class="avatar bg-info text-white">
...
<Example lang="html" name="components-avatar-4" componentName="Avatar" code={`<div class="avatar rounded bg-primary text-white">CUI</div>
...
<Example lang="html" name="components-avatar-5" componentName="Avatar" code={`<div class="avatar rounded-0 bg-primary text-white">CUI</div>
...
<Example lang="html" name="components-avatar-6" componentName="Avatar" code={`<div class="avatar avatar-xl bg-secondary">CUI</div>
...
<Example lang="html" name="components-avatar-7" componentName="Avatar" code={`<div class="avatars-stack">
    <div class="avatar">
      <img class="avatar-img" src="/assets/img/avatars/1.jpg" alt="user@email.com">
    </div>
    <div class="avatar">
...
<Example lang="html" name="components-avatar-8" componentName="Avatar" code={`<div class="avatar">
    <img class="avatar-img" src="/assets/img/avatars/1.jpg" alt="user@email.com">
...
<ScssDocs file="scss/_variables.scss" capture="avatar-variables" />
