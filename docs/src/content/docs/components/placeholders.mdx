...
<Example lang="html" name="components-placeholders-1" componentName="Placeholders" code={`<p aria-hidden="true">
    <span class="placeholder col-6"></span>
  </p>
...
<Example lang="html" name="components-placeholders-2" componentName="Placeholders" code={`<span class="placeholder col-6"></span>
...
<Example lang="html" name="components-placeholders-3" componentName="Placeholders" code={`<span class="placeholder col-12"></span>
...
<Example lang="html" name="components-placeholders-4" componentName="Placeholders" code={`<span class="placeholder col-12 placeholder-lg"></span>
...
<Example lang="html" name="components-placeholders-5" componentName="Placeholders" code={`<p class="placeholder-glow">
    <span class="placeholder col-12"></span>
  </p>
