...
<Callout color="info">
Both animations rely on the `prefers-reduced-motion` media query and stop for readers who ask for less motion. For more information, refer to the [reduced motion section of our accessibility documentation](/getting-started/accessibility/#reduced-motion).
</Callout>
