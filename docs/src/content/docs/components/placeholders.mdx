...
<Example lang="html" name="components-placeholders-1" componentName="Placeholders" code={[`<p aria-hidden="true">`, `  <span class="placeholder col-6"></span>`, `</p>`, ``, `<a class="btn btn-primary disabled placeholder col-4" aria-disabled="true"></a>`]} html={[`<p aria-hidden="true">`, `  <span class="placeholder col-6"></span>`, `</p>`, ``, `<a class="btn btn-primary disabled placeholder col-4" aria-disabled="true"></a>`]} />
...
<Example lang="html" name="components-placeholders-5" componentName="Placeholders" code={[`<p class="placeholder-glow">`, `  <span class="placeholder col-12"></span>`, `</p>`, ``, `<p class="placeholder-wave">`, `  <span class="placeholder col-12"></span>`, `</p>`]} html={[`<p class="placeholder-glow">`, `  <span class="placeholder col-12"></span>`, `</p>`, ``, `<p class="placeholder-wave">`, `  <span class="placeholder col-12"></span>`, `</p>`]} />
