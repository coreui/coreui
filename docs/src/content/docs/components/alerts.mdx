...
<Example lang="html" name="components-alerts-1" componentName="Alerts" code={`<div class="alert alert-primary" role="alert">
...
<Example lang="html" name="components-alerts-3" componentName="Alerts" code={`<div class="alert alert-primary" role="alert">
...
<Example lang="html" name="components-alerts-4" componentName="Alerts" code={`<div class="alert alert-success" role="alert">
...
<Example lang="html" name="components-alerts-5" componentName="Alerts" code={`<div class="alert alert-primary d-flex align-items-center" role="alert">
...
<Example lang="html" name="components-alerts-6" componentName="Alerts" code={`<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
...
<Example lang="html" name="components-alerts-7" componentName="Alerts" code={`<div class="alert bg-primary text-white" role="alert">
...
<Example lang="html" name="components-alerts-8" componentName="Alerts" code={`<div class="alert alert-warning alert-dismissible fade show" role="alert">
