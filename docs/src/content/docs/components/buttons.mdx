...
<Example lang="html" name="components-buttons-1" componentName="Buttons" code={`<button type="button" class="btn">Base class</button>`} />
...
<Example lang="html" name="components-buttons-2" componentName="Buttons" code={`<button type="button" class="btn btn-primary">Primary</button>
...
<Example lang="html" name="components-buttons-3" componentName="Buttons" code={`<button type="button" class="btn btn-primary"><span class="cil-contrast"></span> Primary</button>
...
<Example lang="html" name="components-buttons-4" componentName="Buttons" code={`<a class="btn btn-primary" href="#" role="button">Link</a>
...
<Example lang="html" name="components-buttons-5" componentName="Buttons" code={`<button type="button" class="btn btn-outline">Base outline button</button>
...
<Example lang="html" name="components-buttons-6" componentName="Buttons" code={`<button type="button" class="btn btn-outline-primary">Primary</button>
...
<Example lang="html" name="components-buttons-7" componentName="Buttons" code={`<button type="button" class="btn btn-ghost">Base ghost button</button>
...
<Example lang="html" name="components-buttons-8" componentName="Buttons" code={`<button type="button" class="btn btn-ghost-primary">Primary</button>
...
<Example lang="html" name="components-buttons-9" componentName="Buttons" code={`<button type="button" class="btn btn-primary btn-lg">Large button</button>
  <button type="button" class="btn btn-secondary btn-lg">Large button</button>`} />

<Example lang="html" name="components-buttons-10" componentName="Buttons" code={`<button type="button" class="btn btn-primary btn-sm">Small button</button>
  <button type="button" class="btn btn-secondary btn-sm">Small button</button>`} />

You can even roll your own custom sizing with CSS variables:

<Example lang="html" name="components-buttons-11" componentName="Buttons" code={`<button type="button" class="btn btn-primary"
...
<Example lang="html" name="components-buttons-12" componentName="Buttons" code={`<button type="button" class="btn btn-primary rounded-pill">Primary</button>
...
<Example lang="html" name="components-buttons-13" componentName="Buttons" code={`<button type="button" class="btn btn-primary rounded-0">Primary</button>
...
<Example lang="html" name="components-buttons-14" componentName="Buttons" code={`<button type="button" class="btn btn-lg btn-primary" disabled>Primary button</button>
...
<Example lang="html" name="components-buttons-15" componentName="Buttons" code={`<a href="#" class="btn btn-primary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Primary link</a>
...
<Example lang="html" name="components-buttons-16" componentName="Buttons" code={`<a href="#" class="btn btn-primary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Primary link</a>
  <a href="#" class="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Link</a>`} />
...
<Example lang="html" name="components-buttons-17" componentName="Buttons" code={`<div class="d-grid gap-2">
...
<Example lang="html" name="components-buttons-18" componentName="Buttons" code={`<div class="d-grid gap-2 d-md-block">
    <button class="btn btn-primary" type="button">Button</button>
    <button class="btn btn-primary" type="button">Button</button>
  </div>`} />
...
<Example lang="html" name="components-buttons-19" componentName="Buttons" code={`<div class="d-grid gap-2 col-6 mx-auto">
    <button class="btn btn-primary" type="button">Button</button>
    <button class="btn btn-primary" type="button">Button</button>
  </div>`} />
...
<Example lang="html" name="components-buttons-20" componentName="Buttons" code={`<div class="d-grid gap-2 d-md-flex justify-content-md-end">
...
<Example lang="html" name="components-buttons-21" componentName="Buttons" code={`<p class="d-inline-flex gap-1">
...
<Example lang="html" name="components-buttons-22" componentName="Buttons" code={`<p class="d-inline-flex gap-1">
