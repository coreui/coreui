...
<Example code={`<button type="button" class="btn btn-primary"><span class="cil-contrast"></span> Primary</button>
...
<Example code={`<button type="button" class="btn btn-outline-primary">Primary</button>
...
<Example code={`<button type="button" class="btn btn-ghost-primary">Primary</button>
