...
<Example lang="html" name="layout-css-grid-1" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center">`, `  <div class="g-col-4">.g-col-4</div>`, `  <div class="g-col-4">.g-col-4</div>`, `  <div class="g-col-4">.g-col-4</div>`, `</div>`]} html={[`<div class="grid text-center">`, `  <div class="g-col-4">.g-col-4</div>`, `  <div class="g-col-4">.g-col-4</div>`, `  <div class="g-col-4">.g-col-4</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-3" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} html={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-4" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} html={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-6" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center">`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `</div>`]} html={[`<div class="grid text-center">`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `</div>`]} />

This behavior can be mixed with grid column classes.

<Example lang="html" name="layout-css-grid-7" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `</div>`]} html={[`<div class="grid text-center">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `  <div>1</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-9" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="--cui-columns: 3;">`, `  <div>Auto-column</div>`, `  <div>Auto-column</div>`, `  <div>Auto-column</div>`, `</div>`]} html={[`<div class="grid text-center" style="--cui-columns: 3;">`, `  <div>Auto-column</div>`, `  <div>Auto-column</div>`, `  <div>Auto-column</div>`, `</div>`]} />

### Columns and gaps

Adjust the number of columns and the gap.

<Example lang="html" name="layout-css-grid-10" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="--cui-columns: 4; --cui-gap: 5rem;">`, `  <div class="g-col-2">.g-col-2</div>`, `  <div class="g-col-2">.g-col-2</div>`, `</div>`]} html={[`<div class="grid text-center" style="--cui-columns: 4; --cui-gap: 5rem;">`, `  <div class="g-col-2">.g-col-2</div>`, `  <div class="g-col-2">.g-col-2</div>`, `</div>`]} />

<Example lang="html" name="layout-css-grid-11" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="--cui-columns: 10; --cui-gap: 1rem;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-4">.g-col-4</div>`, `</div>`]} html={[`<div class="grid text-center" style="--cui-columns: 10; --cui-gap: 1rem;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-4">.g-col-4</div>`, `</div>`]} />

### Adding rows

Adding more rows and changing the placement of columns:

<Example lang="html" name="layout-css-grid-12" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="--cui-rows: 3; --cui-columns: 3;">`, `  <div>Auto-column</div>`, `  <div class="g-start-2" style="grid-row: 2">Auto-column</div>`, `  <div class="g-start-3" style="grid-row: 3">Auto-column</div>`, `</div>`]} html={[`<div class="grid text-center" style="--cui-rows: 3; --cui-columns: 3;">`, `  <div>Auto-column</div>`, `  <div class="g-start-2" style="grid-row: 2">Auto-column</div>`, `  <div class="g-start-3" style="grid-row: 3">Auto-column</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-13" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="row-gap: 0;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} html={[`<div class="grid text-center" style="row-gap: 0;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} />
...
<Example lang="html" name="layout-css-grid-14" componentName="CSS Grid" class="docs-example-cssgrid" code={[`<div class="grid text-center" style="--cui-gap: .25rem 1rem;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} html={[`<div class="grid text-center" style="--cui-gap: .25rem 1rem;">`, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, ``, `  <div class="g-col-6">.g-col-6</div>`, `  <div class="g-col-6">.g-col-6</div>`, `</div>`]} />
