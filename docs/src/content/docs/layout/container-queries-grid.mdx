...
<Example lang="html" name="layout-container-queries-grid-1" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
      <div class="cq-col">
        Column
      </div>
...
<Example lang="html" name="layout-container-queries-grid-2" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
      <div class="cq-col">
        1 of 2
      </div>
...
<Example lang="html" name="layout-container-queries-grid-3" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
      <div class="cq-col">
        1 of 3
      </div>
...
<Example lang="html" name="layout-container-queries-grid-4" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
...
<Example lang="html" name="layout-container-queries-grid-5" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
...
<Example lang="html" name="layout-container-queries-grid-6" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
...
<Example lang="html" name="layout-container-queries-grid-7" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
...
<Example lang="html" name="layout-container-queries-grid-8" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
...
<Example lang="html" name="layout-container-queries-grid-9" componentName="Grid system (Container Query version)" class="docs-example-row" code={`<div class="container text-center">
    <div class="cq-row">
