...
<Example code={`<div class="container px-4 text-center">
    <div class="row gx-5">
      <div class="col">
...
<Example code={`<div class="container overflow-hidden text-center">
    <div class="row gx-5">
      <div class="col">
       <div class="p-3 border bg-light">Custom column padding</div>
      </div>
...
<Example code={`<div class="container text-center">
    <div class="row g-2">
      <div class="col-6">
        <div class="p-3 border bg-light">Custom column padding</div>
      </div>
