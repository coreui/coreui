...
<Example lang="html" name="utilities-spacing-1" componentName="Spacing" class="docs-example-cssgrid" code={`<div style="grid-template-columns: 1fr 1fr;" class="d-grid gap-3">
...
<Example lang="html" name="utilities-spacing-2" componentName="Spacing" class="docs-example-cssgrid" code={`<div style="grid-template-columns: 1fr 1fr;" class="d-grid gap-0 row-gap-3">
    <div class="p-2">Grid item 1</div>
    <div class="p-2">Grid item 2</div>
    <div class="p-2">Grid item 3</div>
    <div class="p-2">Grid item 4</div>
...
<Example lang="html" name="utilities-spacing-3" componentName="Spacing" class="docs-example-cssgrid" code={`<div style="grid-template-columns: 1fr 1fr;" class="d-grid gap-0 column-gap-3">
    <div class="p-2">Grid item 1</div>
    <div class="p-2">Grid item 2</div>
    <div class="p-2">Grid item 3</div>
    <div class="p-2">Grid item 4</div>
