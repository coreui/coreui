...
<Example lang="html" name="utilities-vertical-align-1" componentName="Vertical alignment" code={`<span class="align-baseline">baseline</span>
...
<Example lang="html" name="utilities-vertical-align-2" componentName="Vertical alignment" code={`<table style="height: 100px;">
    <tbody>
      <tr>
