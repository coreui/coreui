...
<div class="toast d-flex align-items-center" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  <button type="button" class="btn-close ms-auto me-2" data-coreui-dismiss="toast" aria-label="Close"></button>
</div>
{{< /example >}}
...
<div class="toast d-flex align-items-center text-white bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  <button type="button" class="btn-close btn-close-white ms-auto me-2" data-coreui-dismiss="toast" aria-label="Close"></button>
</div>
{{< /example >}}
