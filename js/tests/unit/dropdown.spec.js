...
describe('Dropdown', () => {
  ...
  describe('data-api', () => {
    ...
    it('should manage bs attribute `data-coreui-popper`="none" when dropdown is in navbar', done => {
      fixtureEl.innerHTML = [
        '<nav class="navbar navbar-expand-md navbar-light bg-light">',
        '  <div class="dropdown">',
        '    <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" aria-expanded="false">Dropdown</button>',
      ...
      btnDropdown.addEventListener('shown.coreui.dropdown', () => {
        expect(dropdownMenu.getAttribute('data-coreui-popper')).toEqual('none')
        dropdown.hide()
      })
    ...
    it('should manage bs attribute `data-coreui-popper`="static" when display set to static', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-display="static">Dropdown</button>',
        '  <div class="dropdown-menu">',
    ...
    it('should close dropdown (only) by clicking inside the dropdown menu when it has data-attribute `data-coreui-auto-close="inside"`', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
    ...
    it('should close dropdown (only) by clicking outside the dropdown menu when it has data-attribute `data-coreui-auto-close="outside"`', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
    ...
    it('should not close dropdown by clicking inside or outside the dropdown menu when it has data-attribute `data-coreui-auto-close="false"`', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
