...
describe('Offcanvas', () => {
  ...
  describe('config', () => {
    ...
    it('should read data attributes and override default config', () => {
      fixtureEl.innerHTML = [
        '<div class="offcanvas" data-coreui-scroll="true" data-coreui-backdrop="false"  data-coreui-keyboard="false">',
        '</div>'
      ].join('')
  ...
  describe('show', () => {
    ...
    it('should not fire shown when show is prevented', done => {
      ...
      offCanvasEl.addEventListener('show.coreui.offcanvas', e => {
        e.preventDefault()
        expectEnd()
      })
  ...
  describe('hide', () => {
    ...
    it('should not fire hidden when hide is prevented', done => {
      ...
      offCanvasEl.addEventListener('hide.coreui.offcanvas', e => {
        e.preventDefault()
        expectEnd()
      })
