...
describe('Carousel', () => {
  ...
  describe('constructor', () => {
    ...
    it('should not add touch event listeners if touch supported = false', () => {
      ...
      EventHandler.off(carouselEl, '.coreui-carousel')
  ...
  describe('data-api', () => {
    ...
    it('should create carousel and go to the next slide on click (with real button controls)', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button id="next" class="carousel-control-next" data-coreui-target="#myCarousel" type="button" data-coreui-slide="next"></div>',
        '</div>'
      ].join('')
    ...
    it('should create carousel and go to the next slide on click (using links as controls)', done => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <a class="carousel-control-prev" href="#myCarousel" role="button" data-coreui-slide="prev"></button>',
        '  <a id="next" class="carousel-control-next" href="#myCarousel" role="button" data-coreui-slide="next"></div>',
        '</div>'
      ].join('')
    ...
    it('should do nothing if no carousel class on click on arrows', () => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <button class="carousel-control-prev" data-coreui-target="#myCarousel" type="button" data-coreui-slide="prev"></div>',
        '  <button id="next" class="carousel-control-next" data-coreui-target="#myCarousel" type="button" data-coreui-slide="next"></div>',
        '</div>'
      ].join('')
