...
describe('SelectorEngine', () => {
  ...
  describe('getSelectorFromElement', () => {
    it('should get selector from data-coreui-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-coreui-target=".target"></div>',
    ...
    it('should get selector from href if no data-coreui-target set', () => {
      fixtureEl.innerHTML = [
    ...
    it('should get selector from href if data-coreui-target equal to #', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-coreui-target="#" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return null if a selector from a href is a url without an anchor', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-coreui-target="#" href="foo/bar.html"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return the anchor if a selector from a href is a url', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-coreui-target="#" href="foo/bar.html#target"></a>',
        '<div id="target"></div>'
      ].join('')
  ...
  describe('getElementFromSelector', () => {
    it('should get element from data-coreui-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-coreui-target=".target"></div>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should get element from href if no data-coreui-target set', () => {
      fixtureEl.innerHTML = [
        '<a id="test" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
  ...
  describe('getMultipleElementsFromSelector', () => {
    it('should get elements from data-coreui-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-coreui-target=".target"></div>',
        '<div class="target"></div>',
        '<div class="target"></div>'
    ...
    it('should get elements if several ids with special chars are given', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-coreui-target="#j_id11:exampleModal,#j_id22:exampleModal"></div>',
