...
describe('ScrollBar', () => {
  ...
  describe('hide - reset', () => {
    it('should adjust the inline padding of fixed elements which are full-width', done => {
      ...
      expect(fixedEl2.getAttribute('data-coreui-padding-right')).toEqual('5px', 'original fixed element padding should be stored in data-coreui-padding-right')
      ...
      expect(fixedEl2.getAttribute('data-coreui-padding-right')).toEqual(null, 'data-coreui-padding-right should be cleared after closing')
