...
describe('ScrollBar', () => {
  ...
  describe('hide - reset', () => {
    it('should adjust the inline padding of fixed elements which are full-width', done => {
      ...
      expect(getPaddingAttr(fixedEl)).toEqual(`${originalPadding}px`, 'original fixed element padding should be stored in data-coreui-padding-right')
      expect(getPaddingAttr(fixedEl2)).toEqual(`${originalPadding2}px`, 'original fixed element padding should be stored in data-coreui-padding-right')
      ...
      expect(getPaddingAttr(fixedEl)).toEqual(null, 'data-coreui-padding-right should be cleared after closing')
      expect(getPaddingAttr(fixedEl2)).toEqual(null, 'data-coreui-padding-right should be cleared after closing')
    ...
    it('should adjust the inline margin and padding of sticky elements', done => {
      ...
      expect(getMarginAttr(stickyTopEl)).toEqual(`${originalMargin}px`, 'original sticky element margin should be stored in data-coreui-margin-right')
      expect(getMarginX(stickyTopEl)).toEqual(expectedMargin, 'sticky element margin should be adjusted while opening')
      expect(getPaddingAttr(stickyTopEl)).toEqual(`${originalPadding}px`, 'original sticky element margin should be stored in data-coreui-margin-right')
      expect(getPaddingX(stickyTopEl)).toEqual(expectedPadding, 'sticky element margin should be adjusted while opening')

      scrollBar.reset()
      expect(getMarginAttr(stickyTopEl)).toEqual(null, 'data-coreui-margin-right should be cleared after closing')
      expect(getMarginX(stickyTopEl)).toEqual(originalMargin, 'sticky element margin should be reset after closing')
      expect(getPaddingAttr(stickyTopEl)).toEqual(null, 'data-coreui-margin-right should be cleared after closing')
    ...
    it('should not put data-attribute if element doesn\'t have the proper style property, should just remove style property if element didn\'t had one', () => {
      ...
      const hasPaddingAttr = el => el.hasAttribute('data-coreui-padding-right')
      const hasMarginAttr = el => el.hasAttribute('data-coreui-margin-right')
