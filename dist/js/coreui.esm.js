...
class Alert extends BaseComponent {
  ...
  static jQueryInterface(config) {
    return this.each(function () {
      let data = Data.get(this, DATA_KEY$d);
...
class Button extends BaseComponent {
  ...
  static jQueryInterface(config) {
    return this.each(function () {
      let data = Data.get(this, DATA_KEY$c);
...
EventHandler.on(document, EVENT_CLICK_DATA_API$8, SELECTOR_DATA_TOGGLE$6, event => {
  ...
  let data = Data.get(button, DATA_KEY$c);
...
class Collapse extends BaseComponent {
  ...
  _addAriaAndCollapsedClass(element, triggerArray) {
    ...
    const isOpen = element.classList.contains(CLASS_NAME_SHOW$9);
...
EventHandler.on(document, EVENT_CLICK_DATA_API$6, SELECTOR_DATA_TOGGLE$5, function (event) {
  ...
  selectorElements.forEach(element => {
    const data = Data.get(element, DATA_KEY$a);
    let config;
...
class Dropdown extends BaseComponent {
  ...
  toggle() {
    ...
    const isActive = this._element.classList.contains(CLASS_NAME_SHOW$8);
  ...
  show() {
    if (this._element.disabled || this._element.classList.contains(CLASS_NAME_DISABLED) || this._menu.classList.contains(CLASS_NAME_SHOW$8)) {
      return;
    }
  ...
  static clearMenus(event) {
    ...
    for (let i = 0, len = toggles.length; i < len; i++) {
      const context = Data.get(toggles[i], DATA_KEY$9);
      const relatedTarget = {
      ...
      const hideEvent = EventHandler.trigger(toggles[i], EVENT_HIDE$5, relatedTarget);
...
const EVENT_FOCUSIN$1 = `focusin${EVENT_KEY$8}`;
...
class Modal extends BaseComponent {
  ...
  dispose() {
    [window, this._element, this._dialog].forEach(htmlElement => EventHandler.off(htmlElement, EVENT_KEY$8));
    super.dispose();
    /**
  ...
  static jQueryInterface(config, relatedTarget) {
    return this.each(function () {
      let data = Data.get(this, DATA_KEY$8);
...
EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$3, function (event) {
  ...
  let data = Data.get(target, DATA_KEY$8);
